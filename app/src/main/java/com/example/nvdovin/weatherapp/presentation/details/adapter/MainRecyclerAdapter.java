...
public class MainRecyclerAdapter extends RecyclerView.Adapter<ViewHolder<DailyForecast>> {
    ...
    class ForecastCard extends ViewHolder<DailyForecast> {
    ...
    class ParametersCard extends ViewHolder<DailyForecast> {
        ...
        public void bindData(DailyForecast data) {
            ...
            windspeed.setText(String.valueOf(currentWeatherData.getWindSpeed().intValue()).concat(ExtractRes.getResource(context, R.string.rain_sign)));
